...
<head> 
    ...
    <link rel="stylesheet" type="text/css" href="destination-americas.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css">
    <title>UTS Travel/travel/package/americas</title>
</head>
	...
	<div class="wrapper_top_bar">
		<div class="container_top_bar">
            ...
            echo '<div class="text_top_bar">Welcome Traveler</div>';
                ...
                echo '<div class="text_top_bar">Welcome ' .$fetch['fullname'].' Traveler</div>';
            }
            ?>
...
<section class="package" id="package">
    <h1 class="heading">
        <span>Travel Package in The Americas</span>
...
?>
    <div class="box-container">
        ...
        WHERE o.package_id IS NULL AND tp.destination IN ('The Americas', 'Americas')";
