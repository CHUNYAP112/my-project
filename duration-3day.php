...
<head> 
    ...
    <link rel="stylesheet" type="text/css" href="duration-3day.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css">
    <title>UTS Travel/travel/package/3day</title>
</head>
...
<section class="package" id="package">
    <h1 class="heading">
        <span>1 ~ 3 DAY Travel Package</span>
...
?>
    <div class="box-container">
        ...
        WHERE o.package_id IS NULL AND tp.day BETWEEN 1 AND 3";
            ...
            <div class="row">
                ...
                <div class ="footer-col">
                    ...
                    <div class ="social-links">
                        <a href="ttps://www.facebook.com/profile.php?id=100011997855735&mibextid=ZbWKwL"><i class="fab fa-facebook-f"></i></a>
