...
<head> 
    ...
    <title>ADMIN SYSTEM/order-completed</title>
</head>
...
<div class="container">
        <h1 class="heading">
        <span class="travel-title"> <a href ="">Completed Order</a> ||</span>
        <span> <a href ="order-cancel.php">Cancel Order</a></span>
        </h1>
        </div>
</section>
...
if (isset($_POST['submit'])) {
    ...
    if ($update_stmt) {
        ...
        if ($update_stmt->execute()) {
            ...
            window.location.href = 'order-completed.php?order_id={$order_id}';
          </script>";
        } else {
            echo "<script>
...
$select_orders = $conn->query("SELECT * FROM `order` WHERE payment_status = 'completed'");
if ($select_orders) {
