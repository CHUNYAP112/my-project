...
<head> 
    ...
    <link rel="stylesheet" type="text/css" href="order-details.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css">
    <title>ADMIN SYSTEM/order-details</title>
</head>
...
<div class="container">
        <h1 class="heading">
            <span class="travel-title">TRAVEL PACKAGE ORDER</span>
        </h1>
        </div>
</section>
...
if (isset($_POST['submit'])) {
    ...
    if ($update_stmt) {
        ...
        if ($update_stmt->execute()) {
            ...
            window.location.href = 'order-details.php?order_id={$order_id}';
          </script>";
        } else {
...
$select_orders = $conn->query("SELECT * FROM `order` WHERE payment_status = 'pending'");
if ($select_orders) {
